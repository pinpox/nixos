...
Group.new('@comment',                            c.Blue,         c.none, no)
...
Group.new('@label.json',                         c.TODO,         c.none, no)
...
Group.new('@punctuation.delimiter',              c.BrightWhite,  c.none, no)
...
Group.new('@spell',                              c.White,        c.none, no)
Group.new('@spell.lua',                          c.Green,        c.none, no)
Group.new('@spell.bash',                         c.Green,        c.none, no)
Group.new('@spell.comment',                      c.BrightWhite,  c.none, i)
