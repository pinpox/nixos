...
Group.new('CursorColumn', c.none,      c.BrightBlack,       no)
Group.new('CursorLine',   c.none,      c.BrightBlack,       no)
...
Group.new('PMenuSel',     c.none,      c.BrightBlack,       no)
Group.new('PMenuSbar',    c.none,      c.BrightBlack,       no)
...
Group.new('TSTagDelimiter',       c.BrightBlack,       c.none, no)
