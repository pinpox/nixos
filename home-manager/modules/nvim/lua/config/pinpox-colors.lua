...
Group.new('@punctuation.special',                c.BrightWhite,  c.none, no)
...
Group.new('@spell.markdown',                     c.none,         c.none, i)
...
Group.new('@text.uri',                           c.Cyan,         c.none, no)
...
v.g.terminal_color_15 = nixcolors.White
