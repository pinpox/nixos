...
vim.o.completeopt      = "menuone,noselect" -- TODO: What does this do?
vim.o.foldlevelstart   = 20                 -- start with open folds
vim.o.foldmethod       = "syntax"           -- set folding based on syntax
vim.o.hidden           = true               -- Hide buffer when, but don't unload
...
vim.o.mouse            = "a"                -- TODO: What does this do?
...
vim.o.inccommand       = "nosplit"          -- TODO: What does this do?
