...
-- Ansi color numers TODO translate to these colors instaed of baseXX notation
-- Color  Normal Bright Base16
-- Black  0      8      base00
-- Red    1      9      base08
-- Green  2      10     base0B
-- Yellow 3      11     base0A
...
-- Color.new('Black',        '#TODO')
-- Color.new('Red',          '#TODO')
-- Color.new('Green',        '#TODO')
-- Color.new('Yellow',       '#TODO')
-- Color.new('Blue',         '#TODO')
-- Color.new('Purple',       '#TODO')
-- Color.new('Cyan',         '#TODO')
-- Color.new('White',        '#TODO')

-- Color.new('DarkBlack',    '#TODO')
-- Color.new('DarkRed',      '#TODO')
-- Color.new('DarkGreen',    '#TODO')
-- Color.new('DarkYellow',   '#TODO')
-- Color.new('DarkBlue',     '#TODO')
-- Color.new('DarkPurple',   '#TODO')
-- Color.new('DarkCyan',     '#TODO')
-- Color.new('DarkWhite',    '#TODO')

-- Color.new('DarkBlack',    '#TODO')
-- Color.new('BrightRed',    '#TODO')
-- Color.new('BrightGreen',  '#TODO')
-- Color.new('BrightYellow', '#TODO')
-- Color.new('BrightBlue',   '#TODO')
-- Color.new('BrightPurple', '#TODO')
-- Color.new('BrightCyan',   '#TODO')
-- Color.new('BrightWhite',  '#TODO')
...
Group.new('FoldColumn',                    c.base02, c.base02, no)
Group.new('IncSearch',                     c.base00, c.base0C, no)
Group.new('LineNr',                        c.base03, c.none,   no)
Group.new('CursorLineNr',                  c.base05, c.base02, no)
Group.new('MatchParen',                    c.base08, c.base02, ul + b)
...
Group.new('PMenu',                         c.none,   c.base02, no)
...
Group.new('SpecialKey',                    c.base03, c.none,   no)
Group.new('Whitespace',                    c.base03, c.none,   no)
Group.new('StatusLine',                    c.base05, c.base03, no)
Group.new('StatusLineNC',                  c.base02, c.none,   no)
Group.new('TabLine',                       c.base04, c.base02, no)
Group.new('TabLineFill',                   c.base02, c.base02, no)
Group.new('TabLineSel',                    c.base02, c.base0C, no)
Group.new('Title',                         c.base05, c.none,   b)
Group.new('Visual',                        c.none,   c.base02, no)
Group.new('VisualNOS',                     c.none,   c.base02, no)
...
Group.new('DiffAdd',                       c.base0B, c.base02, no)
Group.new('DiffChange',                    c.base0A, c.base02, no)
Group.new('DiffDelete',                    c.base08, c.base02, no)
Group.new('DiffText',                      c.base0C, c.base02, no)
Group.new('DiffAdded',                     c.base0B, c.base02, no)
Group.new('DiffFile',                      c.base08, c.base02, no)
Group.new('DiffNewFile',                   c.base0B, c.base02, no)
Group.new('DiffLine',                      c.base0C, c.base02, no)
Group.new('DiffRemoved',                   c.base08, c.base02, no)
...
Group.new('MatchTag',                      c.base08, c.base02, ul + b)
...
Group.new('NormalFloat',                   c.base05, c.base02, no)
...
Group.new('LspDiagnosticsFloatingError',          c.base08, g.base02, ul)
Group.new('LspDiagnosticsFloatingWarning',        c.base09, g.base02, ul)
Group.new('LspDiagnosticsFloatingInformation',    c.base07, g.base02, ul)
Group.new('LspDiagnosticsFloatingHint',           c.base0B, g.base02, ul)
