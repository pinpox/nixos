...
in
{
  ...
  # pi models.json for local llama-cpp provider (symlinked into default PI_CODING_AGENT_DIR)
  systemd.tmpfiles.rules = [
    "d /home/pinpox/.pi/agent 0755 pinpox users -"
    "L+ /home/pinpox/.pi/agent/models.json - - - - ${piModelsJson}"
  ];
