...
" Last Updated: Fri 26 Jun 2020 09:02:49 AM CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Normal guifg=#ffffff guibg=#1f1f24 guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#1f1f24 guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  hi None guifg=#ffffff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CursorLineNr guifg=#ffffff guibg=#26262b guisp=NONE gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#1f1f24 guibg=#1f1f24 guisp=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#52555c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#52555c guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#52555c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi MatchWord guifg=#ffffff guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=#52555c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Signify guifg=#4484d1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#52555c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#ffffff guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=#34353b guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  hi PmenuSel guifg=#ffffff guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  hi PmenuThumb guifg=#43454b guibg=#43454b guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#ff8a7a guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ModeMsg guifg=#838991 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi MoreMsg guifg=#ff85b8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#ff85b8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi WarningMsg guifg=#ff8a7a guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#26262b guisp=NONE gui=NONE cterm=NONE
  hi CursorColumn guifg=NONE guibg=#26262b guisp=NONE gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#26262b guisp=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=#ffffff guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#ffffff guibg=#43454b guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#838991 guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#34353b guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#ffffff guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#1f1f24 guibg=#fef937 guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#ffffff guibg=#43454b guisp=NONE gui=NONE cterm=NONE
  ...
  hi Error guifg=#1f1f24 guibg=#ff8a7a guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#ffa14f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#83c9bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#ff85b8 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Character guifg=#d9c668 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#6bdfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Number guifg=#d9c668 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#aeb7c0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#ff8a7a guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Title guifg=#ffffff guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Todo guifg=#aeb7c0 guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi markdownDelimiter guifg=#83c9bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi markdownCode guifg=#e5cfff guibg=#34353b guisp=NONE gui=NONE cterm=NONE
  if g:xcodedarkhc_green_comments
    hi Comment guifg=#8dbf67 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi SpecialComment guifg=#b8f08d guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Todo guifg=#b8f08d guibg=NONE guisp=NONE gui=bold cterm=bold
  endif
  if g:xcodedarkhc_emph_types
    hi Typedef guifg=#6bdfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#b1faeb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#e5cfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi Typedef guifg=#4ec4e6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#83c9bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#cda1ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedarkhc_emph_funcs
    hi FunctionDef guifg=#6bdfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#b1faeb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#e5cfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi FunctionDef guifg=#4ec4e6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#83c9bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#cda1ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedarkhc_emph_idents
    hi IdentifierDef guifg=#6bdfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#b1faeb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#e5cfff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi IdentifierDef guifg=#4ec4e6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#83c9bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#cda1ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedarkhc_match_paren_style
    hi MatchParen guifg=#1f1f24 guibg=#fef937 guisp=NONE gui=NONE cterm=NONE
  else
    hi MatchParen guifg=#ffffff guibg=#0f5bca guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodedarkhc_dim_punctuation
    hi Delimiter guifg=#aeb7c0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#aeb7c0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi Delimiter guifg=#ffffff guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#ffffff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
