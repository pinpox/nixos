      ...
      clan = clan-core.lib.clan {
        ...
        inventory = {
          ...
          instances = {
            ...
            #   roles.server.machines.kfbox.settings = {
            #     ip = "192.168.8.5";
            #     tld = "c";
            #   };
            #
            #   # machine hosting https://ca.c (our CA for SSL)
            #   roles.default.machines.kfbox.settings = {
            #     ip = "192.168.8.5";
            #     services = [ "ca" ];
            #   };
            #
            #   # machine hosting https://blub.c (some internal web-service)
            #   # TODO make this a different machine than the one trying to reach
            #   # it for better example
            #   roles.default.machines.kiwi.settings = {
            #     ip = "192.168.8.6";
            #     services = [ "blub" ];
            #   };
            # };
            ...
            #   roles.ca.machines.kfbox.settings.tlds = [ "c" ];
            #   roles.default.machines.kiwi = { };
            # };

            # Set up a service on kiwi
            # importer-blub = {
            #   module.name = "importer";
            #   roles.default.machines.kiwi = { };
            #   roles.default.extraModules = [
            #     # Set the ACME endpoint to your CA for the blub.c service
            #     { security.acme.certs."blub.c".server = "https://ca.c/acme/acme/directory"; }
            #     {
            ...
            #           forceSSL = true;
            #           locations."/" = {
            #             return = "200 'Hello from kiwi, this is blub.c!'";
