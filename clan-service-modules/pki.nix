...
}:
{
  ...
  manifest.readme = "Provides Root CA and automatic TLS endpoint certificates for clan services.";

  roles.default = {
    description = "TLS certificate infrastructure (Root CA, endpoint certs)";
